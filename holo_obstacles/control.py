...
kr = 0.02 # repulsive potential gain 0.02
ka = 1.5 # attractive potential gain 1.5
pmax = 0.3
...
def updateWheels(t, robotPos, robotYaw, goalPos, obstaclesPos):
    ...
    return goToPosition(p, robotYaw, goalPos)
    #return [0,0,0]
...
def potentialField(robotPos, goalPos, obstaclesPos):
    potential = - attractivePotentialGradient(robotPos, goalPos)
    for o in obstaclesPos:
        potential += - repulsivePotentialGradient(robotPos, o)
    print ("potentialField = ", potential)
    return potential
